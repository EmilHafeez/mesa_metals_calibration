...
What regression is implemented in the Excel sheet specifically, and also, what regression should we implement in our analyses? The spectroscopy software computes some transformations and additional changes which do not appear in the Excel. The regressions used here are similar to the Excel sheet (though need adjustment, see Section 2).
