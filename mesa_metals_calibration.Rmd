...
Some columns only have 37 rows of data, and I selectedf 38 to catch all of it. Therefore there are entirely blank rows in the list-column's nested data. The below does not remove it, obviously; ignorable for now but must troubleshoot
```{r}
